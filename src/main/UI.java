        ...
        if(textField.equals("0") || textField.equals("impossible") || textField.equals("undefined")){
            jTextField1.setText(string);
                ...
                //}else{
                    ...
                    System.err.println("Error 4: Beyond 15 characters");
                    JOptionPane.showMessageDialog(UI.this, "You can't surpass 15 characters limit  ","Alert", JOptionPane.WARNING_MESSAGE);
    ...
    private void arithmeticOperation(){
        ...
        switch(calculation){
            ...
            case 1:
                ...
                if(decimalFormat.format(answer).length() > 16){
